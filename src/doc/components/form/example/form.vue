	...
	<wtf-space width="500px">
		<wtf-form>
			...
			<wtf-form-item label="多选">
				<wtf-checkbox-group name="checkbox">
					<wtf-space>
						<wtf-checkbox value="0">checkbox 1</wtf-checkbox>
						<wtf-checkbox value="1">checkbox 2</wtf-checkbox>
						<wtf-checkbox value="2">checkbox 3</wtf-checkbox>
					</wtf-space>
				</wtf-checkbox-group>
			</wtf-form-item>
